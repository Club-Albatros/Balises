...
var Comments = React.createClass({
  ...
  addComment: function(e) {
    ...
    this.service.addComment(this.props.flightId, this.props.sessionId, comment, function(data) {
  ...
  loadMoreComments: function(e) {
    ...
    if (this.state.canLoadMore) {
      this.service.loadComments(this.props.flightId, this.props.sessionId, this.state.lastPage + 1, this.props.pageSize, function(data) {
